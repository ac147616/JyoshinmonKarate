...
namespace JyoshinmonKarate.Controllers
{
    public class MembershipsController : Controller
    {
        ...
        public MembershipsController(JyoshinmonKarateContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MembershipId,MembershipName,Cost,AgeGroup")] Membership membership)
        {
